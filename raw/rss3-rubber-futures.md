...
# TFEX RSS3 Rubber Futures — Research Notes
...
| Settlement | **Physical delivery** (default) — F.O.B. Bangkok/Laem Chabang or approved warehouse |
| Final settlement price | VWAP on last trading day (if volume threshold met), else avg of last 3 daily settlements |
| Daily price limit | ±5% → ±10% |
| Position limit | **1,000 contracts** (nearest month); **10,000 contracts** (all months combined) |
| Exchange fee | Max **THB 40 / side** |
...
| Trading hours | Day only — pre-open 09:15–09:45; trading 09:45–16:55 (no night) |
| Last trading day | **4th business day before** last bus day of month; trading ends **13:15** |
| Settlement | **Cash in THB** |
| Final settlement | **OSE RSS3 settlement price** on last trading day; no FX adjustment |
| Position limit | Exchange discretion |
| Exchange fee | Max **THB 4 / side** |
...
rubber. TFEX publicly worked to stretch rubber liquidity. Most
professional rubber exposure via TFEX is through **JRF** (cash-settled,
OSE-referenced) rather than physical RSS3.

## Sources

[^1]: TFEX — RSS3 Futures Contract Specification.
    https://www.tfex.co.th/en/products/agriculture/rss3-futures/contract-specification
[^2]: TFEX — RSS3D Futures Contract Specification.
    https://www.tfex.co.th/en/products/agriculture/rss3d-futures/contract-specification
[^3]: TFEX — Japanese Rubber Futures (JRF) Spec PDF.
    https://media.tfex.co.th/tfex/Documents/2023/Mar/JRF_EN_21092021.pdf
[^4]: TFEX — Agriculture Product Page.
